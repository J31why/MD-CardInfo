 ...
 int processId
    ...
    out IntPtr lpNumberOfBytesRead);
     ...
     out IntPtr lpNumberOfBytesWritten);
        ...
        public static int[] TIDaddresses = new int[] { 0x1CB7A40, 0xb8, 0, 0x18, 0x20, 0x34 };
        public static int[] MainDeckCount = new int[] { 0x1CCD278, 0xb8, 0, 0xF8, 0x1C0, 0x90, 0x18 };
        public static int[] MainDeck = new int[] { 0x1CCD278, 0xb8, 0, 0xF8, 0x1C0, 0x90, 0x10, 0x20 };
        public static int[] ExDeckCount = new int[] { 0x1CCD278, 0xb8, 0, 0xF8, 0x1C0, 0x98, 0x18 };
        public static int[] ExDeck = new int[] { 0x1CCD278, 0xb8, 0, 0xF8, 0x1C0, 0x98, 0x10, 0x20 };
        ...
        public static int? GetCardTID()
        {
            return ReadInt(TIDaddresses);
        }
