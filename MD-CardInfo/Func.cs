 ...
 int processId
    ...
    out IntPtr lpNumberOfBytesRead);
     ...
     out IntPtr lpNumberOfBytesWritten);
        ...
        public static int[] CheckCardIndex = new int[] { 0x01F3FC10, 0xb8, 0, 0x40, 0x10, 0x20, 0x110, 0x34 }; //检查卡片的序号
        public static int[] CheckCardArray = new int[] { 0x01F3FC10, 0xb8, 0, 0x40, 0x10, 0x20, 0x20, 0x18, 0x48, 0x10, 0x20 }; //检查卡片的数组
        public static int[] CheckRewardInSolo = new int[] { 0x01F3FC10, 0xb8, 0, 0x40, 0x10, 0x28, 0x90, 0x40,0x20,0x4C }; //SOLO模式下检查奖励卡片的ID


        public static int[] DuelCID = new int[] { 0x01F31DA8, 0xb8, 0, 0x4c }; //决斗界面
        public static int[] EditCID = new int[] { 0x01F501A8, 0xb8, 0, 0xF8,0x200,0x2c }; //编辑界面
        public static int[] ViewCID = new int[] { 0x01F501A8, 0xb8, 0, 0xF8, 0x138, 0x2c }; //卡组浏览界面

        public static int[] MainDeckCount = new int[] { 0x01F501A8, 0xb8, 0, 0xF8, 0x1E8, 0x148, 0x18 };
        public static int[] MainDeck = new int[] { 0x01F501A8, 0xb8, 0, 0xF8, 0x1E8, 0x148, 0x10, 0x20 };
        public static int[] ExDeckCount = new int[] { 0x01F501A8, 0xb8, 0, 0xF8, 0x1E8, 0x150, 0x18 };
        public static int[] ExDeck = new int[] { 0x01F501A8, 0xb8, 0, 0xF8, 0x1E8, 0x150, 0x10, 0x20 };
